...
Formula: BPM=SamplingRate×60PeakIntervalBPM = \frac{SamplingRate \times 60}{PeakInterval}BPM=PeakIntervalSamplingRate×60​


SpO₂
Using the standard ratio:
R=ACred/DCredACir/DCirR = \frac{AC_{red}/DC_{red}}{AC_{ir}/DC_{ir}}R=ACir​/DCir​ACred​/DCred​​
...
Example:
<img width="655" height="526" alt="image" src="https://github.com/user-attachments/assets/79e94a3f-ae76-4db3-80a5-fdd98a1bea7b" />
